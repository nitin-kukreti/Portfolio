        ...
        <Flex direction={isNotSmallerScreen ? "row" : "column"}
            ...
            <Box alignSelf="center" px="32" py="16">
                ...
                <Flex direction={isNotSmallerScreen ? "row" : "column"} mt={8} >
                    <Flex rounded="xl" direction="column" mt={4} bg="blue.400" h="30vh" w="15vw" minW="200px" minH="200px" justify="flex-end">
                        <Icon color="white" padding="4" as={DiAndroid} w="24" h="24" />
                    ...
                    <Flex rounded="xl" direction="column" mt={4} ml={isNotSmallerScreen ? 4 : 0}
                        minW="200px"
                        minH="200px"
                        bg="gray.100" h="30vh" w="15vw" justify="flex-end" _hover={{ bg: "teal.400", }}>
                    ...
                    <Flex rounded="xl" direction="column" mt={4} ml={isNotSmallerScreen ? 4 : 0}
                        bg="gray.100" h="30vh" w="15vw" justify="flex-end"
                        minW="200px"
                        minH="200px"
                        _hover={{ bg: "green.400", }}
